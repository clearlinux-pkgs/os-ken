...
%prep
%setup -q -n os-ken-1.1.0
cd %{_builddir}/os-ken-1.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592585191
...
cp %{_builddir}/os-ken-1.1.0/LICENSE %{buildroot}/usr/share/package-licenses/os-ken/294b43b2cec9919063be1a3b49e8722648424779
